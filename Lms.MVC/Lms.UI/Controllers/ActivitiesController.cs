...
namespace Lms.MVC.UI.Controllers
{
    ...
    public class ActivitiesController : Controller
    {
        ...
        public IActionResult Create(int Id)
        {
            ...
            activityViewModel.ActivityType = new SelectList(db.ActivityTypes, nameof(ActivityType.Id), nameof(ActivityType.Name));
        ...
        public async Task<IActionResult> Create(ActivityViewModel activityViewModel)
        {
            ...
            if (await db.SaveChangesAsync() == 1) return RedirectToAction("Index", new { id = activityViewModel.ModuleId });
            else return RedirectToAction("Index");//, "Activities");
