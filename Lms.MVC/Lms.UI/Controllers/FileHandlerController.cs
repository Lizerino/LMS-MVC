...
namespace Lms.MVC.UI.Controllers
{
    public class StreamingController : Controller
    {
        ...
        // TODO: What should be allowed
        private readonly string[] permittedMicrosoftWordExtensions = { ".docx",".dotx",".docb"};
        private readonly string[] permittedMicrosoftExcelExtensions = {".xls",".xlt" };
        //private readonly string[] permittedExtensions = permitttedMic
